...
AppCallbacks.Instance.InvokeOnAppThread(new AppCallbackItem(() => { AdRotatorUnitySDK.Integration.AdRotatorBridge.Register(mainPage, toCall => AppCallbacks.Instance.InvokeOnUIThread(new AppCallbackItem(toCall), false)); }), false);
